...
public class Solution {
  ...
  static int countingValleys(int n, String s) {
    ...
    for (int i = 0; i < chars.length; i++) {
      ...
      Integer step = Solution.converCharToNumber(chars[i]);

      if(currentAltitude == 0 && step == -1){
        canCount = true;
      }

      currentAltitude = currentAltitude + step;
  ...
  private static Integer converCharToNumber(Character character){
    return character.toString().equals("D") ? -1 : 1;
  }
  ...
  public static void main(String[] args){
    ...
    System.out.println(Solution.countingValleys(12, steps));
